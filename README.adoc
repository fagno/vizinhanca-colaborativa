...
Já estão sabendo da iniciativa dos moradores da 407 sul para implantar o monitoramento remoto por câmeras na quadra? Explico! 
...
- Dizer se pode disponibilizar o seu rede de internet para uma das câmeras caso alguma fique na sua residência ou próximo dela.
...
video::q4sY42xZBZE[youtube,width=640,height=480]

== Distribuição das 30 Câmeras Iniciais do Projeto 

NOTE: Instalação a ser iniciada na semana do dia 14/06/2021.

NOTE: Pagamento da 1ª mensalidade a partir de 10/07

.Pontos Câmeras
image::pontos-cameras.png[width=400,height=300]